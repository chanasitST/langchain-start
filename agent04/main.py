...
def create_knowledge_base(path: str):
    """Creates a dummy text file with enough content for explanations."""
    content = """
...
def main():
    print("\n🧠 Starting Day 4: Explanations (Verification)...\n")
    ...
    try:
        ...
        # 5. ask questions and generate explanations
        questions = [
        ...
        for question in questions:
            explanation = generate_explanation(question, retriever)
            print(f"\n📝 Explanation:\n{explanation}\n")
            print("-" * 80)
